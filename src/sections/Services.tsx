  ...
  return (
    <section id="services" className="px-6 md:px-8 py-28 md:py-36 bg-paper/40">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-px bg-line rounded-2xl overflow-hidden border border-line">
          {services.map((s, i) => (
            <FadeIn
              as="div"
              key={s.id}
              delay={i * 0.06}
              className="bg-ink p-8 md:p-10 hover:bg-paper-hi transition-colors"
            >
